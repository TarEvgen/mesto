...
export const popupBtnOpenUpdataAvatar = document.querySelector(
...
export const buttonSubmitAddCard = cardForm.querySelector(
  formsConfig.submitButtonSelector
);
export const buttonSubmitAddProfile = profileForm.querySelector(
  formsConfig.submitButtonSelector
);
export const buttonSubmitUpdataAvatar = avatarForm.querySelector(
  formsConfig.submitButtonSelector
);
